...
@Column(name="cont_fecha_actualizacion_defini ")
...
/**
 * @return the ustracontAdmi
 */
public String getUstracontAdmi() {
	return ustracontAdmi;
}

/**
 * @param ustracontAdmi the ustracontAdmi to set
 */
public void setUstracontAdmi(String ustracontAdmi) {
	this.ustracontAdmi = ustracontAdmi;
}
...
public String toString() {
	return "Contrato [idContrato=" + idContrato + ", proveedor=" + proveedor + ", tipCont=" + tipCont + ", numCont="
			...
			+ ", ustracontAdmi=" + ustracontAdmi + ", contTec=" + contTec + ", contPrecio=" + contPrecio
			+ ", contModPag=" + contModPag + ", contFechaIni=" + contFechaIni + ", contFechaFin=" + contFechaFin
			+ ", contMant=" + contMant + ", contFechaIniMan=" + contFechaIniMan + ", contFechaFinMan=" + contFechaFinMan
