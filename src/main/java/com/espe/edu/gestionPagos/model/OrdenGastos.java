 ...
 * @return the tempCi
 */
public DatosEmpleado getTempCi() {
	return tempCi;
}
 ...
 */
public void setTempCi(DatosEmpleado tempCi) {
	this.tempCi = tempCi;
}
...
public String toString() {
	return "OrdenGastos [numOrden=" + numOrden + ", tempCi=" + tempCi + ", certificadoPresupuestario="
